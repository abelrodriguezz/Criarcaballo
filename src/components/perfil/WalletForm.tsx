      ...
      <div className="border border-[var(--border)] rounded-2xl p-5 mb-4">
        <div className="flex justify-between items-center gap-3">
          <div className="min-w-0">
            ...
            {walletActual ? (
              <div className="text-[13px] text-foreground-muted font-mono truncate mt-0.5">
                {walletActual}
              </div>
            ) : (
              <div className="text-[13px] text-foreground-muted mt-0.5">
